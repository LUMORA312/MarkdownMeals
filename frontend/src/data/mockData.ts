...
export const restaurants: Restaurant[] = [
  {
    ...
    dishes: [
      ...
      { id: 'd2', name: 'Ribeye Steak', image: '/images/steak.jpg', category: 'Steak & Grill', primaryTaste: 'Savory', modifiers: [], price: 18.99, originalPrice: 28.99, dealType: 'Happy Hour', dealExpiresAt: hours(3) },
      ...
      { id: 'd6', name: 'Grilled Salmon', image: '/images/salmon.jpg', category: 'Seafood', primaryTaste: 'Fresh', modifiers: [], price: 14.99, originalPrice: 22.00, dealType: 'Happy Hour', dealExpiresAt: hours(2) },
  ...
  },
  {
    ...
    dishes: [
      ...
      { id: 'd12', name: 'Grilled Teriyaki Salmon', image: '/images/salmon.jpg', category: 'Seafood', primaryTaste: 'Savory', modifiers: [], price: 13.99, originalPrice: 19.99, dealType: 'Happy Hour', dealExpiresAt: hours(3) },
      ...
      { id: 'd16', name: 'Wagyu Burger', image: '/images/burger.jpg', category: 'Burgers & Sandwiches', primaryTaste: 'Savory', modifiers: [], price: 11.99, originalPrice: 18.99, dealType: 'Happy Hour', dealExpiresAt: hours(2) },
  ...
  },
  {
    ...
    dishes: [
      ...
      { id: 'd21', name: 'Seafood Linguine', image: '/images/salmon.jpg', category: 'Seafood', primaryTaste: 'Fresh', modifiers: [], price: 12.99, originalPrice: 19.99, dealType: 'Happy Hour', dealExpiresAt: hours(3) },
      ...
      { id: 'd26', name: 'Grilled Branzino', image: '/images/steak.jpg', category: 'Seafood', primaryTaste: 'Fresh', modifiers: [], price: 15.99, originalPrice: 24.99, dealType: 'Happy Hour', dealExpiresAt: hours(2) },
