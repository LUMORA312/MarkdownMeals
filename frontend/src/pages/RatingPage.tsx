...
import { ArrowLeft, Clock, UtensilsCrossed, Check, Loader2 } from 'lucide-react';
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground font-body">{token.restaurant.name}</p>
          </div>
        </div>
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
          {token.dishes.map((dish) => (
            <div key={dish.id} className="flex-shrink-0 w-16">
            ...
            {selectedEmoji && (
              ...
              >
                <button
                  ...
                  className="px-8 py-3 rounded-full bg-primary text-primary-foreground font-body font-semibold shadow-food cursor-pointer disabled:opacity-50"
                >
