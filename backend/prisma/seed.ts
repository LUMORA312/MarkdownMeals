    ...
    data: {
      ...
      dishes: {
        create: [
          ...
          { name: 'Ribeye Steak', image: '/images/steak.jpg', category: 'Steak & Grill', primaryTaste: 'Savory', price: 18.99, originalPrice: 28.99, dealType: 'Happy Hour', dealExpiresAt: hours(3), modifiers: { create: [] } },
          ...
          { name: 'Grilled Salmon', image: '/images/salmon.jpg', category: 'Seafood', primaryTaste: 'Fresh', price: 14.99, originalPrice: 22.00, dealType: 'Happy Hour', dealExpiresAt: hours(2), modifiers: { create: [] } },
    ...
    data: {
      ...
      dishes: {
        create: [
          ...
          { name: 'Grilled Teriyaki Salmon', image: '/images/salmon.jpg', category: 'Seafood', primaryTaste: 'Savory', price: 13.99, originalPrice: 19.99, dealType: 'Happy Hour', dealExpiresAt: hours(3), modifiers: { create: [] } },
          ...
          { name: 'Wagyu Burger', image: '/images/burger.jpg', category: 'Burgers & Sandwiches', primaryTaste: 'Savory', price: 11.99, originalPrice: 18.99, dealType: 'Happy Hour', dealExpiresAt: hours(2), modifiers: { create: [] } },
    ...
    data: {
      ...
      dishes: {
        create: [
          ...
          { name: 'Seafood Linguine', image: '/images/salmon.jpg', category: 'Seafood', primaryTaste: 'Fresh', price: 12.99, originalPrice: 19.99, dealType: 'Happy Hour', dealExpiresAt: hours(3), modifiers: { create: [] } },
          ...
          { name: 'Grilled Branzino', image: '/images/steak.jpg', category: 'Seafood', primaryTaste: 'Fresh', price: 15.99, originalPrice: 24.99, dealType: 'Happy Hour', dealExpiresAt: hours(2), modifiers: { create: [] } },
